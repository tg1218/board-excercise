...
class ArticleControllerTest {
    ...
    public ArticleControllerTest(@Autowired MockMvc mvc, @Autowired FormDataEncoder encoder) {
        this.mvc = mvc;
    ...
    @Test
    @DisplayName("[veiw][GET] 해시태그 검색 페이지 - 정상 호출, 해시 태그 입력")
    ...
    @DisplayName("[view][GET] 새 게시글 작성 페이지 - 인증")
    @WithMockUser
    @Test
    ...
    @DisplayName("[view][GET] 새 게시글 작성 페이지 - 인증되지 않은 사용자")
    @Test
    void givenNothing_whenRequesting_thenRedirectLoginPage() throws Exception {
        // Given
    ...
    @WithUserDetails(value = "tg", setupBefore = TestExecutionEvent.TEST_EXECUTION)
    @Test
    ...
    void givenArticleIdToDelete_whenRequesting_thenDeletesArticle() throws Exception {
        // Given
        long articleId = 1L;
        willDoNothing().given(articleService).deleteArticle(articleId, "tg");
        ...
        mvc.perform(
                ...
                .andExpect(view().name("redirect:/articles"))
                .andExpect(redirectedUrl("/articles"));
        then(articleService).should().deleteArticle(articleId, "tg");
    }
